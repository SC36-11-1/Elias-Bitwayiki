...
Digital Earth Citizen/Electronic Citizenship Definitions
Digital Identity
...
Brain Computer Interface - using electroencephalography (BCI -EEG)
	-https://en.wikipedia.org/wiki/Brain–computer_interfac—
Heart Rate monitor 
	-https://en.wikipedia.org/wiki/Heart_rate_monito—
Breathalyzer / CO Monitor - Breath quality 
	-https://en.wikipedia.org/wiki/Breath_carbon_monoxide-
	-https://www.lumen.me
Body Temperature Monitor
	-https://www.healthline.com/health/types-of-thermometer
...
Motion SENSOR (bad evolving backwards)
	-https://en.wikipedia.org/wiki/Motion_detector
Motion tracker‼️(Kinect Good Good✨)
